        ...
        return(
            <div className='container'>
                <div className='row'>  
                    ...
                    <div className='col-md-8'>
                        ...
                        <div className='row'>
                            ...
                            <div style={{marginTop:'15px',
                                         color:'#606060',
                                         fontWeight:'700',
                                         fontSize:'14px'}}>Catatan Untuk Penjual (Opsional) </div>
                            <input type='text' 
                                    style={{marginTop:'13px'}} 
                                    placeholder='Contoh Warna Putih, Ukuran XL, Edisi Kedua' 
                                    className='form-control' />
                            </div>
                    ...
                    ?
                    <div className='row mt-4'>
                        <input className='btn border-secondary col-md-2' value='Wishlist'/>
                        <input className='btn btn-primary col-md-3' value='Beli Sekarang'/>
                        <input className='btn btn-primary col-md-3' value='Tambah Ke Keranjang'/>
                    </div>
                    :
                    <div className='row mt-4'>
                        <input className='btn border-secondary col-md-2' value='Wishlist'/>
